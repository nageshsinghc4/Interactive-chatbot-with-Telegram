...
class SimpleDialogueManager(object):
    ...
    def __init__(self):
        ...
        chatbot = ChatBot('MLWhizChatterbot', logic_adapters=[
        ...
        self.intent_recognizer =  pickle.load(open('/Users/nageshsinghchauhan/Documents/projects/chatbot/stackoverflow/data/intent_clf.pkl', 'rb'))
        self.tag_classifier =  pickle.load(open('/Users/nageshsinghchauhan/Documents/projects/chatbot/stackoverflow/data/tag_clf.pkl', 'rb'))
        # Load the TFIDF vectorizer object
        self.tfidf_vectorizer = pickle.load(open('/Users/nageshsinghchauhan/Documents/projects/chatbot/stackoverflow/data/tfidf.pkl', 'rb'))
...
def main():
    token = '1059210621:AAHIK7WpeDITjEzckhpc5GGPv4mTR10WUPo'
